...
ggplot(fisher_test_rs_vs_notrs_df_no_location_full_table, aes(x = mean_odd_ratio_101, y = -log10(adj_combined_pvalue_101), color = concordance_odd_ratio_101)) + 
  geom_point() + 
...
ggplot(fisher_test_rs_vs_notrs_df_no_location_full_table, aes(x = mean_odd_ratio_HSO, y = -log10(adj_combined_pvalue_HSO), color = concordance_odd_ratio_HSO)) + 
  geom_point() + 
...
ggplot(fisher_test_rs_vs_notrs_df_no_location_full_table, aes(x = mean_odd_ratio_101, y = -log10(adj_combined_pvalue_101), color = qval_adj_combined_pvalue_101_FDR_5)) + 
  geom_point() + 
  ...
  scale_colour_discrete(labels = paste(levels(fisher_test_rs_vs_notrs_df_no_location_full_table$qval_adj_combined_pvalue_101_FDR_5), table(fisher_test_rs_vs_notrs_df_no_location_full_table$qval_adj_combined_pvalue_101_FDR_5)))

ggplot(fisher_test_rs_vs_notrs_df_no_location_full_table, aes(x = mean_odd_ratio_101, y = -log10(adj_combined_pvalue_101), color = qval_adj_combined_pvalue_101_FDR_10)) + 
  geom_point() + 
  ...
  scale_colour_discrete(labels = paste(levels(fisher_test_rs_vs_notrs_df_no_location_full_table$qval_adj_combined_pvalue_101_FDR_10), table(fisher_test_rs_vs_notrs_df_no_location_full_table$qval_adj_combined_pvalue_101_FDR_10)))
```

##### List of significant sequence with a 5% FDR

```{r}
datatable(fisher_test_rs_vs_notrs_df_no_location_full_table[fisher_test_rs_vs_notrs_df_no_location_full_table$qval_adj_combined_pvalue_101_FDR_5 == TRUE, 
...
```{r}
datatable(fisher_test_rs_vs_notrs_df_no_location_full_table[fisher_test_rs_vs_notrs_df_no_location_full_table$qval_adj_combined_pvalue_101_FDR_10 == TRUE, 
                                                            c("adj_combined_pvalue_101", "qval_adj_combined_pvalue_101")])
```
...
ggplot(fisher_test_rs_vs_notrs_df_no_location_full_table, aes(x = mean_odd_ratio_HSO, y = -log10(adj_combined_pvalue_HSO), color = qval_adj_combined_pvalue_HSO_FDR_5)) + 
  geom_point() + 
  ...
  xlab("Mean odd ratio of Fisher test") + 
  labs(color = "Is qvalue significant at FDR 5%?") +
  scale_colour_discrete(labels = paste(levels(fisher_test_rs_vs_notrs_df_no_location_full_table$qval_adj_combined_pvalue_HSO_FDR_5), table(fisher_test_rs_vs_notrs_df_no_location_full_table$qval_adj_combined_pvalue_HSO_FDR_5)))

ggplot(fisher_test_rs_vs_notrs_df_no_location_full_table, aes(x = mean_odd_ratio_HSO, y = -log10(adj_combined_pvalue_HSO), color = qval_adj_combined_pvalue_HSO_FDR_10)) + 
  geom_point() + 
  ...
  xlab("Mean odd ratio of Fisher test") + 
  labs(color = "Is qvalue significant at FDR 10%?") +
  scale_colour_discrete(labels = paste(levels(fisher_test_rs_vs_notrs_df_no_location_full_table$qval_adj_combined_pvalue_HSO_FDR_10), table(fisher_test_rs_vs_notrs_df_no_location_full_table$qval_adj_combined_pvalue_HSO_FDR_10)))
```

##### List of significant sequence with a 5% FDR

```{r}
datatable(fisher_test_rs_vs_notrs_df_no_location_full_table[fisher_test_rs_vs_notrs_df_no_location_full_table$qval_adj_combined_pvalue_HSO_FDR_5 == TRUE, 
...
```{r}
datatable(fisher_test_rs_vs_notrs_df_no_location_full_table[fisher_test_rs_vs_notrs_df_no_location_full_table$qval_adj_combined_pvalue_HSO_FDR_10 == TRUE, 
                                                            c("adj_combined_pvalue_HSO", "qval_adj_combined_pvalue_HSO")])
```
...
```{r}
sample_101_significant_seq_qval <- as.data.frame( rownames(fisher_test_rs_vs_notrs_df_no_location_full_table[fisher_test_rs_vs_notrs_df_no_location_full_table$qval_adj_combined_pvalue_101_FDR_5 == TRUE, 
                                            c("adj_combined_pvalue_101", "qval_adj_combined_pvalue_101")]))
colnames(sample_101_significant_seq_qval) <- "significant_sequences_with_FDR_5"

sample_HSO_significant_seq_qval <- as.data.frame( rownames(fisher_test_rs_vs_notrs_df_no_location_full_table[fisher_test_rs_vs_notrs_df_no_location_full_table$qval_adj_combined_pvalue_HSO_FDR_5 == TRUE, 
                                            c("adj_combined_pvalue_HSO", "qval_adj_combined_pvalue_HSO")]))
...
```{r}
sample_101_significant_seq_qval <- as.data.frame( rownames(fisher_test_rs_vs_notrs_df_no_location_full_table[fisher_test_rs_vs_notrs_df_no_location_full_table$qval_adj_combined_pvalue_101_FDR_10 == TRUE, 
                                            c("adj_combined_pvalue_101", "qval_adj_combined_pvalue_101")]))
colnames(sample_101_significant_seq_qval) <- "significant_sequences_with_FDR_10"

sample_HSO_significant_seq_qval <- as.data.frame( rownames(fisher_test_rs_vs_notrs_df_no_location_full_table[fisher_test_rs_vs_notrs_df_no_location_full_table$qval_adj_combined_pvalue_HSO_FDR_10 == TRUE, 
                                            c("adj_combined_pvalue_HSO", "qval_adj_combined_pvalue_HSO")]))
