...
fisher_test_rs_vs_notrs_samples <- cbind(fisher_test_rs_vs_notrs_samples, combined_adj_pval_101 = do.call(rbind,lapply(rv_vs_notrs_101_combined_pval,function(v){v$p})))
...
fisher_test_rs_vs_notrs_samples <- cbind(fisher_test_rs_vs_notrs_samples, combined_adj_pval_HSO = do.call(rbind,lapply(rv_vs_notrs_HSO_combined_pval,function(v){v$p})))
...
ggplot(fisher_test_rs_vs_notrs_full_table, aes(x = mean_odd_ratio_101, y = -log10(combined_adj_pval_101), color = concordance_odd_ratio_101)) + 
  geom_point() + 
...
ggplot(fisher_test_rs_vs_notrs_full_table, aes(x = mean_odd_ratio_HSO, y = -log10(combined_adj_pval_HSO), color = concordance_odd_ratio_HSO)) + 
  geom_point() + 
...
```{r}
sample_101_significant_seq_combined_pval <- as.data.frame( rownames(fisher_test_rs_vs_notrs_full_table[fisher_test_rs_vs_notrs_full_table$combined_adj_pval_101 < 0.05,]))
...
```{r}
sample_HSO_significant_seq_combined_pval <- as.data.frame( rownames(fisher_test_rs_vs_notrs_full_table[fisher_test_rs_vs_notrs_full_table$combined_adj_pval_HSO < 0.05,]))
